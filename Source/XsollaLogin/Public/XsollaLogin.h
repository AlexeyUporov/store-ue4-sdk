...
public:
	 ...
	 * Beware of calling this during the shutdown phase.  Your module could be already unloaded.
	 *
	 * @return Returns singleton instance, loads the module on demand if needed.
	 */
